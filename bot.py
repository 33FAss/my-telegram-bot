...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "«Sinerkin Camp» — трансформационная программа с глубокой личной работой. Поэтому мы берём не всех (это правда): каждый участник проходит короткую диагностику, чтобы убедиться — действительно ли тебе подойдет программа.\n\n"
